...
const AuthOp = () => {
  ...
  return (
    <div className="max-w-md bg-white w-full rounded p-12 ">
      ...
      <div>
        <button
          className="flex items-center justify-between border rounded-lg w-full bg-black text-white px-3 py-2 my-6"
          onClick={() => {
            signIn("google");
          }}
        >
        ...
        <button
          className="flex items-center justify-between border rounded-lg w-full bg-neutral-200 px-3 py-2 my-6"
          onClick={() => {
            signIn("google");
          }}
        >
